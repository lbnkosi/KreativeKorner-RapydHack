  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CreatorRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CreatorRecord> homePageCreatorRecordList = snapshot.data!;
        // Return an empty Container when the document does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homePageCreatorRecord = homePageCreatorRecordList.isNotEmpty
            ? homePageCreatorRecordList.first
            : null;
        return Title(
            title: 'Home',
            color: FlutterFlowTheme.of(context).primaryColor,
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(0, 20, 0, 0),
                                                  child: StreamBuilder<
                                                      List<MyAdvancesRecord>>(
                                                    stream:
                                                        queryMyAdvancesRecord(
                                                      parent:
                                                          homePageCreatorRecord!
                                                              .reference,
                                                    ),
                                                    builder:
                                                        (context, snapshot) {
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                            listViewIndex) {
                                                          final listViewMyAdvancesRecord =
                                                              listViewMyAdvancesRecordList[
                                                                  listViewIndex];
                                                          return Padding(
                                                            padding:
