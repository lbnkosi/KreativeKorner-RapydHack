...
class IncomeProtectionApplyPageWidget extends StatefulWidget {
  const IncomeProtectionApplyPageWidget({
    Key? key,
    this.ipiId,
  }) : super(key: key);
  ...
  @override
  _IncomeProtectionApplyPageWidgetState createState() =>
      _IncomeProtectionApplyPageWidgetState();
}

class _IncomeProtectionApplyPageWidgetState
    extends State<IncomeProtectionApplyPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CreatorRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CreatorRecord> incomeProtectionApplyPageCreatorRecordList =
            snapshot.data!;
        // Return an empty Container when the document does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final incomeProtectionApplyPageCreatorRecord =
            incomeProtectionApplyPageCreatorRecordList.isNotEmpty
                ? incomeProtectionApplyPageCreatorRecordList.first
                : null;
        return Title(
            title: 'IncomeProtectionApplyPage',
            color: FlutterFlowTheme.of(context).primaryColor,
            child: Scaffold(
              key: scaffoldKey,
                            ...
                            child: Row(
                              ...
                              children: [
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                stream:
                                                    queryIncomeProtectionPlansRecord(
                                                  queryBuilder:
                                                      (incomeProtectionPlansRecord) =>
                                                          incomeProtectionPlansRecord
                                                              .where('ipi_id',
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<IncomeProtectionPlansRecord>
                                                      planIdIncomeProtectionPlansRecordList =
                                                      snapshot.data!;
                                            ...
                                            Padding(
                                              ...
                                              child: FutureBuilder<
                                                ...
                                                future: queryMycardsRecordOnce(
                                                  parent:
                                                      incomeProtectionApplyPageCreatorRecord!
                                                          .reference,
                                                ),
                                                builder: (context, snapshot) {
                                                  // Customize what your widget looks like when it's loading.
                                            ...
                                            Padding(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<IncomeProtectionPlansRecord>
                                                      buttonIncomeProtectionPlansRecordList =
                                                      snapshot.data!;
                                                  // Return an empty Container when the document does not exist.
                                                  if (snapshot.data!.isEmpty) {
                                                    return Container();
                                                  }
                                                  final buttonIncomeProtectionPlansRecord =
                                                      buttonIncomeProtectionPlansRecordList
                                                              .isNotEmpty
                                                          ? buttonIncomeProtectionPlansRecordList
                                                              .first
                                                  ...
                                                  return FFButtonWidget(
                                                    onPressed: () async {
                                                      apiResultsu3 =
                                                        ...
                                                        planId: planIdValue,
                                                        productId:
                                                            buttonIncomeProtectionPlansRecord!
                                                                .productId,
                                                        maxPayout:
                                                            buttonIncomeProtectionPlansRecord!
                                                                .maxPayout,
                                ...
                                Expanded(
                                  child: StreamBuilder<
                                      List<IncomeProtectionPlansRecord>>(
                                    stream: queryIncomeProtectionPlansRecord(
                                      queryBuilder:
                                          (incomeProtectionPlansRecord) =>
                                              incomeProtectionPlansRecord.where(
                                                  'ipi_id',
                                                  isEqualTo: widget.ipiId),
                                      singleRecord: true,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      List<IncomeProtectionPlansRecord>
                                          containerIncomeProtectionPlansRecordList =
                                          snapshot.data!;
                                      // Return an empty Container when the document does not exist.
                                      if (snapshot.data!.isEmpty) {
                                        return Container();
                                      }
                                      final containerIncomeProtectionPlansRecord =
                                          containerIncomeProtectionPlansRecordList
                                                  .isNotEmpty
                                              ? containerIncomeProtectionPlansRecordList
                                                  .first
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            containerIncomeProtectionPlansRecord!
                                                                .maxPayout!,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .title2,
